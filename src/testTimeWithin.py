...
from testpointtime a, testpolytime b  WHERE a.time >= b.time and ST_DWITHIN(a.geom, b.geom, 1000)= True '''
...
for n in range(len(parseArray)):
    ...
    if holder[2] == True:
        ...
        tempOne = "INSERT INTO testTimeWithin (geom) VALUES (ST_GeomFromText("+ "'" + holderTemp + "'" + ", 4269))"
        cur.execute(tempOne)
        conn.commit()
