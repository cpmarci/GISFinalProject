...
cur = conn.cursor()
# counted instances since auto detecting wasted more time
first = 5
testdata = 25
testpoly = 8
points500 =39289
...
counter = 0
'''
Just tested with a basic setup that took in the preprogrammed number of stances 
Below is the main loop for intersection 
Cycling through each pid and checking if the geoms intersect for time
'''
