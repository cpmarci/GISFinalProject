...
from points500 a, poly10 b  WHERE ST_DWITHIN(a.geom, b.geom, 1000)= True '''
...
for n in range(len(parseArray)):
    ...
    if holder[2] == True:
        ...
        tempOne = "INSERT INTO p500poly10WithinNoTime (geom) VALUES (ST_GeomFromText("+ "'" + holderTemp + "'" + ", 4269))"
        cur.execute(tempOne)
        conn.commit()
